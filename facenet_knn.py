...
end_load = time.time()
load_data_time = end_load - st_load
print('time image preparation: {}'.format(load_data_time))
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=42)
knn_clf = neighbors.KNeighborsClassifier(n_neighbors=4, algorithm='ball_tree', weights='uniform')
